...
public class Smartwatch extends CrearDispositivo {

    public Smartwatch(String correoElectronico, String nombreDispositivo, 
    ...
    public void tomarFotoWatch(ArrayList<Smartphone> listaP, ArrayList<Smartwatch> listaC){
        String busqueda;
        String escoger;
        int numero;
    ...
    public void copiarTextoWatch(ArrayList<Smartwatch> lista){
        String busqueda;
        String escoger;
