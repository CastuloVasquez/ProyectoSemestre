...
public class ComputadoraPortatil extends CrearDispositivo {
    
    public ComputadoraPortatil(String correoElectronico, String nombreDispositivo, 
        ...
        super(correoElectronico, nombreDispositivo, visible, encender, encendido, 
                ...
                fotoRecibida,palabraCopiar,palabraNoVisible, confirmacion, llamadaRecibida,
                notificacionCorreo, notificacionFecha, nombreEvento);
    }
    
    public void copiarTextoCompu(ArrayList<ComputadoraPortatil> lista){
        String busqueda;
        String escoger;
    ...
    public void tomarFotoCompou(ArrayList<Smartphone> listaP, ArrayList<ComputadoraPortatil> listaC){
        String busqueda;
        String escoger;
        int numero;
    ...
    public void pegarTextoCompu(ArrayList<ComputadoraPortatil> compu){
